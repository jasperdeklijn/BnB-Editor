...
drop table if exists public.review_legacy_archive cascade;
...
drop table if exists public.user_terms_acceptances cascade;
...
create table public.subscriptions (
  ...
  booking_addon_active boolean not null default false,
  created_at timestamptz not null default now(),
  updated_at timestamptz not null default now(),
...
-- BEGIN REVIEW COLLECTION MIGRATION
begin;
...
commit;
-- END REVIEW COLLECTION MIGRATION

-- BEGIN REVIEW GOLD ACCESS REPAIR
begin;
...
-- END REVIEW GOLD ACCESS REPAIR

-- BEGIN DEFAULT ALL FEATURES
begin;
...
-- END DEFAULT ALL FEATURES

-- BEGIN PUBLISHED WEBSITE BUSINESS LINK REPAIR
begin;
...
-- END PUBLISHED WEBSITE BUSINESS LINK REPAIR

-- BEGIN SIGNUP TERMS ACCEPTANCE
begin;
