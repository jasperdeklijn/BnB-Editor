...
export const SITE_MESSAGES: Record<SupportedWebsiteLocale, SiteMessages> = {
  "nl-NL": {
    ...
    offering: "Aanbod", moreInfo: "Meer info", request: "Aanvragen", availabilityHelp: "Neem contact op voor beschikbaarheid, planning en mogelijkheden.", bookStay: "Boek je verblijf", bookStayIntro: "Kies een accommodatie en stuur een boekingsaanvraag met je gewenste check-in datum.", requestBooking: "Boeking aanvragen", bookingSuccess: "Boekingsaanvraag ontvangen. We nemen zo snel mogelijk contact met je op.", bookingHelper: "We controleren je gewenste periode voordat we deze bevestigen.", planAppointment: "Plan een afspraak", appointmentIntro: "Kies een dienst en stuur een aanvraag met je gewenste datum en tijd.", requestAppointment: "Afspraak aanvragen", appointmentSuccess: "Aanvraag ontvangen. We nemen zo snel mogelijk contact met je op.", appointmentHelper: "We controleren je gewenste moment voordat we dit bevestigen.",
  ...
  "fr-FR": {
    ...
    offering: "Services", moreInfo: "En savoir plus", request: "Demander", availabilityHelp: "Contactez-nous pour connaître les disponibilités, le planning et les possibilités.", bookStay: "Réservez votre séjour", bookStayIntro: "Choisissez un hébergement et envoyez une demande de réservation avec la date d’arrivée souhaitée.", requestBooking: "Demander une réservation", bookingSuccess: "Demande de réservation reçue. Nous vous contacterons dès que possible.", bookingHelper: "Nous vérifierons votre période souhaitée avant de la confirmer.", planAppointment: "Prendre rendez-vous", appointmentIntro: "Choisissez un service et envoyez une demande avec la date et l’heure souhaitées.", requestAppointment: "Demander un rendez-vous", appointmentSuccess: "Demande reçue. Nous vous contacterons dès que possible.", appointmentHelper: "Nous vérifierons votre créneau souhaité avant de le confirmer.",
  ...
  "de-DE": {
    ...
    offering: "Angebot", moreInfo: "Mehr erfahren", request: "Anfragen", availabilityHelp: "Kontaktieren Sie uns zu Verfügbarkeit, Planung und Möglichkeiten.", bookStay: "Aufenthalt buchen", bookStayIntro: "Wählen Sie eine Unterkunft und senden Sie eine Buchungsanfrage mit Ihrem gewünschten Anreisedatum.", requestBooking: "Buchung anfragen", bookingSuccess: "Buchungsanfrage erhalten. Wir melden uns so schnell wie möglich.", bookingHelper: "Wir prüfen Ihren gewünschten Zeitraum, bevor wir ihn bestätigen.", planAppointment: "Termin vereinbaren", appointmentIntro: "Wählen Sie eine Leistung und senden Sie eine Anfrage mit Ihrem Wunschtermin.", requestAppointment: "Termin anfragen", appointmentSuccess: "Anfrage erhalten. Wir melden uns so schnell wie möglich.", appointmentHelper: "Wir prüfen Ihren gewünschten Termin, bevor wir ihn bestätigen.",
