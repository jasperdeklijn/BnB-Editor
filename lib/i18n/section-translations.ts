...
export const SECTION_TRANSLATABLE_FIELDS = {
  ...
  testimonials: [
    ...
    { key: "reviewFormTitle", label: "Formuliertitel" },
    { key: "reviewFormIntro", label: "Introductie formulier" },
    { key: "reviewNameLabel", label: "Label naam" },
    { key: "reviewEmailLabel", label: "Label e-mailadres" },
    { key: "reviewRatingLabel", label: "Label beoordeling" },
    { key: "reviewBodyLabel", label: "Label ervaring" },
    { key: "reviewSubmitLabel", label: "Knoptekst versturen" },
    { key: "reviewEmptyText", label: "Tekst zonder recensies" },
  ],
  faq: [
    { key: "title", label: "Titel", required: true },
    { key: "subtitle", label: "Ondertitel", required: true },
